...
struct Mask2D : public Mask< Coord2D >
{
    Mask2D() = delete;
...
struct CircularMask : public Mask2D< CircularMask >
{
    CircularMask() = delete;
...
struct ParallelogramMask : public Mask2D< ParallelogramMask >
{
    const Coord2D axial_vector0_;
    const Coord2D basis_vertex_;
    ...
    {
        return coord_in_parallelogram_mask(
            origin_,
            radius2_,
            basis_vertex_,
            basis_vector0_,
...
struct EllipticalMask : public Mask2D< EllipticalMask >
{
