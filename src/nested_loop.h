...
//////////////////////////////////////////////////////////////////////
template <int i_func> __global__ void SimpleNestedLoopKernel(int Nx, int *Ny) {
...
//////////////////////////////////////////////////////////////////////
template <int i_func>
__global__ void Smart2DNestedLoopKernel(int ix0, int iy0, int dim_x, int dim_y,
                                        int *sorted_idx, int *sorted_Ny) {
  int ix = (blockIdx.x * blockDim.x) + threadIdx.x;
...
template <int i_func> int Run(int nested_loop_algo, int Nx, int *d_Ny);

template <int i_func> int BlockStepNestedLoop(int Nx, int *d_Ny);

template <int i_func> int CumulSumNestedLoop(int Nx, int *d_Ny);

template <int i_func> int SimpleNestedLoop(int Nx, int *d_Ny);

template <int i_func> int SimpleNestedLoop(int Nx, int *d_Ny, int max_Ny);

template <int i_func> int ParallelInnerNestedLoop(int Nx, int *d_Ny);

template <int i_func> int ParallelOuterNestedLoop(int Nx, int *d_Ny);

template <int i_func> int Frame1DNestedLoop(int Nx, int *d_Ny);

template <int i_func> int Frame2DNestedLoop(int Nx, int *d_Ny);

template <int i_func> int Smart1DNestedLoop(int Nx, int *d_Ny);

template <int i_func> int Smart2DNestedLoop(int Nx, int *d_Ny);
...
//////////////////////////////////////////////////////////////////////
template <int i_func> int NestedLoop::BlockStepNestedLoop(int Nx, int *d_Ny) {
...
//////////////////////////////////////////////////////////////////////
template <int i_func> int NestedLoop::SimpleNestedLoop(int Nx, int *d_Ny) {
  ...
  int max_Ny;
  gpuErrchk(
      cudaMemcpy(&max_Ny, d_max_Ny_, sizeof(int), cudaMemcpyDeviceToHost));
...
//////////////////////////////////////////////////////////////////////
template <int i_func> int NestedLoop::Frame1DNestedLoop(int Nx, int *d_Ny) {
  if (Nx <= 0) {
    return 0;
  }
  int dim_x, dim_y;
  ...
  //<BEGIN-CLANG-TIDY-SKIP>//
  cub::DeviceRadixSort::SortPairs(d_sort_storage_, sort_storage_bytes_, d_Ny,
                                  d_sorted_Ny_, d_idx_, d_sorted_idx_, Nx);
  //<END-CLANG-TIDY-SKIP>//
...
//////////////////////////////////////////////////////////////////////
template <int i_func> int NestedLoop::Frame2DNestedLoop(int Nx, int *d_Ny) {
  if (Nx <= 0) {
    return 0;
  }
...
//////////////////////////////////////////////////////////////////////
template <int i_func> int NestedLoop::Smart1DNestedLoop(int Nx, int *d_Ny) {
  // Find max value of Ny
  //<BEGIN-CLANG-TIDY-SKIP>//
  cub::DeviceReduce::Max(d_reduce_storage_, reduce_storage_bytes_, d_Ny,
                         d_max_Ny_, Nx);
...
//////////////////////////////////////////////////////////////////////
template <int i_func> int NestedLoop::Smart2DNestedLoop(int Nx, int *d_Ny) {
  // Find max value of Ny
  //<BEGIN-CLANG-TIDY-SKIP>//
  cub::DeviceReduce::Max(d_reduce_storage_, reduce_storage_bytes_, d_Ny,
                         d_max_Ny_, Nx);
...
//////////////////////////////////////////////////////////////////////
template <int i_func> int NestedLoop::CumulSumNestedLoop(int Nx, int *d_Ny) {
  // TMP
  ...
  //
  int Ny_sum;
  gpuErrchk(cudaMemcpy(&Ny_sum, &d_Ny_cumul_sum_[Nx], sizeof(int),
                       cudaMemcpyDeviceToHost));
  ...
  */
  ...
  if (Ny_sum > 0) {
    ...
    // double time_mark=getRealTime();
    //
    CumulSumNestedLoopKernel<i_func>
        <<<numBlocks, 1024>>>(Nx, d_Ny_cumul_sum_, Ny_sum);
    gpuErrchk(cudaPeekAtLastError());
    // gpuErrchk(cudaDeviceSynchronize());
