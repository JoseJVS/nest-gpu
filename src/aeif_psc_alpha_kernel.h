...
const std::string aeif_psc_alpha_scal_var_name[N_SCAL_VAR] = {
    "I_syn_ex", "I_syn_in", "I1_syn_ex", "I1_syn_in", "V_m", "w"};
...
const std::string aeif_psc_alpha_group_param_name[N_GROUP_PARAM] = {"h_min_rel",
                                                                    "h0_rel"};
...
__device__ void ExternalUpdate(double x, float *y, float *param,
                               bool end_time_step,
                               aeif_psc_alpha_rk5 data_struct) {
  aeif_psc_alpha_ns::ExternalUpdate<NVAR, NPARAM>(x, y, param, end_time_step,
                                                  data_struct);
}
