...
const std::string aeif_psc_exp_multisynapse_scal_var_name[N_SCAL_VAR] = {"V_m",
                                                                         "w"};
...
template <> int aeif_psc_exp_multisynapse::UpdateNR<0>(long long it, double t1);
...
__device__ void ExternalUpdate(double x, float *y, float *param,
                               bool end_time_step,
                               aeif_psc_exp_multisynapse_rk5 data_struct) {
  aeif_psc_exp_multisynapse_ns::ExternalUpdate<NVAR, NPARAM>(
