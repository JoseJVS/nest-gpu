...
const std::string user_m1_port_param_name[N_PORT_PARAM] = {"E_rev", "tau_syn",
                                                           "g0"};
...
template <> int user_m1::UpdateNR<0>(long long it, double t1);

template <int N_PORT> int user_m1::UpdateNR(long long it, double t1) {
  if (N_PORT == n_port_) {
    const int NVAR = user_m1_ns::N_SCAL_VAR + user_m1_ns::N_PORT_VAR * N_PORT;
    const int NPARAM =
        user_m1_ns::N_SCAL_PARAM + user_m1_ns::N_PORT_PARAM * N_PORT;
