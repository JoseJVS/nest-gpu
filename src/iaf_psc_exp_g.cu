...
__global__ void iaf_psc_exp_g_Update(int n_node, int i_node_0, float *var_arr,
                                     ...
                                     float Theta_rel, float V_reset_rel,
                                     int n_refractory_steps, float P11,
                                     float P22, float P21, float P20) {
...
int iaf_psc_exp_g::Init(int i_node_0, int n_node, int /*n_port*/, int i_group) {
...
int iaf_psc_exp_g::Update(long long it, double t1) {
  ...
  iaf_psc_exp_g_Update<<<(n_node_ + 1023) / 1024, 1024>>>(
      n_node_, i_node_0_, var_arr_, param_arr_, n_var_, n_param_, Theta_rel_,
      V_reset_rel_, n_refractory_steps, P11, P22, P21, P20);
  DBGCUDASYNC;
