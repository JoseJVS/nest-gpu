...
__global__ void user_m1_hc_Update(int n_node, int i_node_0, float *var_arr,
...
user_m1_hc::~user_m1_hc() {
  FreeVarArr();
  FreeParamArr();
}

int user_m1_hc::Init(int i_node_0, int n_node, int /*n_port*/, int i_group) {
