...
NodeSeq NESTGPU::_Create(std::string model_name, uint n_nodes /*=1*/,
                         int n_ports /*=1*/) {
  if (!create_flag_) {
    create_flag_ = true;
  ...
  if (model_name == neuron_model_name[i_iaf_psc_exp_g_model]) {
    ...
    node_vect_.push_back(aeif_psc_exp_group);
             ...
             neuron_model_name[i_aeif_cond_beta_multisynapse_model]) {
    ...
    node_vect_.push_back(aeif_cond_beta_multisynapse_group);
             ...
             neuron_model_name[i_aeif_cond_alpha_multisynapse_model]) {
    ...
    node_vect_.push_back(aeif_cond_alpha_multisynapse_group);
             ...
             neuron_model_name[i_aeif_psc_exp_multisynapse_model]) {
    ...
    node_vect_.push_back(aeif_psc_exp_multisynapse_group);
             ...
             neuron_model_name[i_aeif_psc_alpha_multisynapse_model]) {
...
NodeSeq NESTGPU::Create(std::string model_name, uint n_nodes, int n_ports) {
