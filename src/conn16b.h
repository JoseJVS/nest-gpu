...
template <>
__device__ __forceinline__ void setConnDelay<conn16b_key>(conn16b_key &conn_key,
                                                          int delay) {
  conn_key = (conn_key & (~((uint64_t)DelayMask))) |
             ((delay - MinAllowedDelay) << MaxPortSynNBits);
}
...
template <>
__device__ __forceinline__ void
setConnPort<conn16b_key, conn16b_struct>(conn16b_key &conn_key,
                                         conn16b_struct &conn, int port) {
  conn_key =
      (conn_key & ((~((uint64_t)PortMask)))) | (port << (MaxSynNBits + 1));
}

template <>
__device__ __forceinline__ void
setConnSyn<conn16b_key, conn16b_struct>(conn16b_key &conn_key,
                                        conn16b_struct &conn, int syn) {
...
template <>
__device__ __forceinline__ int
getConnPort<conn16b_key, conn16b_struct>(conn16b_key &conn_key,
                                         conn16b_struct &conn) {
...
template <>
__device__ __forceinline__ int
getConnSyn<conn16b_key, conn16b_struct>(conn16b_key &conn_key,
                                        conn16b_struct &conn) {
...
getConnRemoteFlag<conn16b_key, conn16b_struct>(conn16b_key &conn_key,
                                               conn16b_struct &conn) {
...
template <>
__device__ __forceinline__ void
clearConnRemoteFlag<conn16b_key, conn16b_struct>(conn16b_key &conn_key,
                                                 conn16b_struct &conn) {
  conn_key = conn_key & ~((uint64_t)1 << MaxSynNBits);
}

template <>
int ConnectionTemplate<conn16b_key, conn16b_struct>::_setMaxNodeNBits(
    int max_node_nbits);

template <>
int ConnectionTemplate<conn16b_key, conn16b_struct>::_setMaxDelayNBits(
    int max_delay_nbits);

template <>
int ConnectionTemplate<conn16b_key, conn16b_struct>::_setMaxSynNBits(
    int max_syn_nbits);
