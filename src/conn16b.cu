...
__global__ void setMaxDelayNBits16bKernel(int max_delay_nbits,
                                          ...
                                          int max_port_nbits,
                                          uint port_syn_mask, uint delay_mask,
                                          uint source_mask, uint port_mask) {
...
__global__ void setMaxSynNBits16bKernel(int max_syn_nbits, int max_port_nbits,
                                        uint syn_mask, uint port_mask) {
...
int ConnectionTemplate<conn16b_key, conn16b_struct>::_setMaxDelayNBits(
  ...
  setMaxDelayNBits16bKernel<<<1, 1>>>(max_delay_nbits_, max_port_syn_nbits_,
                                      max_port_nbits_, port_syn_mask_,
                                      delay_mask_, source_mask_, port_mask_);
...
int ConnectionTemplate<conn16b_key, conn16b_struct>::_setMaxSynNBits(
  ...
  // call CUDA kernel to initialize variables in device memory
  setMaxSynNBits16bKernel<<<1, 1>>>(max_syn_nbits_, max_port_nbits_, syn_mask_,
                                    port_mask_);
  DBGCUDASYNC;
