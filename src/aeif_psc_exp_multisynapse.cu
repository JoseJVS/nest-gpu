...
__device__ void NodeInit(int n_var, int n_param, double x, float *y,
                         float *param,
                         aeif_psc_exp_multisynapse_rk5 data_struct) {
  aeif_psc_exp_multisynapse_ns::NodeInit(n_var, n_param, x, y, param,
                                         data_struct);
}
...
{
  aeif_psc_exp_multisynapse_ns::NodeCalibrate(n_var, n_param, x, y, param,
                                              data_struct);
}
...
int aeif_psc_exp_multisynapse::Calibrate(double time_min,
