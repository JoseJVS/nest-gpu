...
# host 0 to host 1
ngpu.RemoteConnect(0, exc_neuron_list, 1, neuron, re_conn_dict, re_syn_dict, hg)
# host 1 to host 0
ngpu.RemoteConnect(1, exc_neuron, 0, neuron_list, re_conn_dict, re_syn_dict, hg)
...
# host 0 to host 1
ngpu.RemoteConnect(0, inh_neuron, 1, neuron, ri_conn_dict, ri_syn_dict, hg)
# host 1 to host 0
ngpu.RemoteConnect(1, inh_neuron, 0, neuron, ri_conn_dict, ri_syn_dict, hg)
