...
parser.add_argument(
    "--file",
    type=str,
    default="benchmark_log",
    help="Output file without extention (default: benchmark_log).",
)
parser.add_argument(
    "--path",
    type=str,
    default=None,
    help="Path for the simulaiton output. Default indicated in sim_params.py.",
)
parser.add_argument(
    "--seed",
    type=int,
    default=12345,
    help="Seed for random number generation (default: 12345).",
)
parser.add_argument(
    "--algo",
    type=int,
    default=0,
    help="Algorithm id for nested loop operation (default: 0). See the script for more detail.",
)
...
net_dict.update(
    {"N_scaling": 1.0, "K_scaling": 1.0, "poisson_input": True, "V0_type": "optimized"}
)
...
info_dict = {"nested_loop_algo": nl_dict[args.algo], "timers": time_dict}
